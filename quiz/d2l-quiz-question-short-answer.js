		...
		<div id="d2l-quiz-question">
			...
			<div>
				<template is="dom-if" if="[[__isEqualTo(questionData.answers.length, 1)]]">
					<div>
						<textarea class="text-area single-row-text-area" rows="[[questionData.answers.0.rows]]" style$="width:[[__convertColsToPx(questionData.answers.0.cols, true)]];"></textarea>
